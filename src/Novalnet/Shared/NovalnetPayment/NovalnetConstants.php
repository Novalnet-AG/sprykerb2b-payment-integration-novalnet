...
interface NovalnetConstants
{
    ...
    public const NOVALNET_FORM_LOGO = 'NOVALNET_FORM_LOGO';
    public const NOVALNET_FORM_CSS_URL = 'NOVALNET_FORM_CSS_URL';
    public const NOVALNET_FORM_HIDE_BLOCKS = 'NOVALNET_FORM_HIDE_BLOCKS';
    public const NOVALNET_FORM_SKIP_PAGES = 'NOVALNET_FORM_SKIP_PAGES';

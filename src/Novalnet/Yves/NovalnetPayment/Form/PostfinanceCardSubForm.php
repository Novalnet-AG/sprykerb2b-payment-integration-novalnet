...
class PostfinanceCardSubForm extends AbstractSubForm
{
    protected const PAYMENT_METHOD = 'postfinance-card';
    ...
    {
        return NovalnetConfig::NOVALNET_PAYMENT_METHOD_POSTFINANCE_CARD;
    }
